...
public class BetterNoise {
    ...
    /**
     * @see <a href="https://en.wikipedia.org/wiki/Ken_Perlin">Ken Perlin</a>
     */
    ...
    private static double fade(double t) {
        //Used to use "3t^2 - 2t^3", but "6t^5 - 15t^4 + 10t^3" is slightly better
    ...
    //this is a precomputed random distribution of integers 1 - 255
